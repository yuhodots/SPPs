...
def nf_resnet18(alpha: float = 0.2, activation: str = 'relu', base_conv: nn.Conv2d = ScaledStdConv2d,
                **kwargs: Any) -> NFResNet:
    ...
    """
    return _nf_resnet('resnet18', BasicBlock, [2, 2, 2, 2], alpha=alpha, activation=activation,
                      base_conv=base_conv, **kwargs)


def nf_resnet34(alpha: float = 0.2,activation: str = 'relu', base_conv: nn.Conv2d = ScaledStdConv2d,
                **kwargs: Any) -> NFResNet:
    ...
    """
    return _nf_resnet('resnet34', BasicBlock, [3, 4, 6, 3], alpha=alpha, activation=activation,
                      base_conv=base_conv, **kwargs)


def nf_resnet50(alpha: float = 0.2, activation: str = 'relu', base_conv: nn.Conv2d = ScaledStdConv2d,
                **kwargs: Any) -> NFResNet:
    ...
    """
    return _nf_resnet('resnet50', Bottleneck, [3, 4, 6, 3], alpha=alpha, activation=activation,
                      base_conv=base_conv, **kwargs)


def nf_resnet101(alpha: float = 0.2, activation: str = 'relu',
    ...
    """
    return _nf_resnet('resnet101', Bottleneck, [3, 4, 23, 3], alpha=alpha, activation=activation,
                      base_conv=base_conv, **kwargs)


def nf_resnet152(alpha: float = 0.2, activation: str = 'relu',
                 base_conv: nn.Conv2d = ScaledStdConv2d, **kwargs: Any) -> NFResNet:
    ...
    """
    return _nf_resnet('resnet152', Bottleneck, [3, 8, 36, 3], alpha=alpha, activation=activation,
                      base_conv=base_conv, **kwargs)


def nf_resnext50_32x4d(alpha: float = 0.2, activation: str = 'relu',
                       base_conv: nn.Conv2d = ScaledStdConv2d, **kwargs: Any) -> NFResNet:
    ...
    return _nf_resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                      alpha=alpha, activation=activation, base_conv=base_conv, **kwargs)


def nf_resnext101_32x8d(alpha: float = 0.2, activation: str = 'relu',
                        base_conv: nn.Conv2d = ScaledStdConv2d, **kwargs: Any) -> NFResNet:
...
def nf_wide_resnet50_2(alpha: float = 0.2, activation: str = 'relu',
                       base_conv: nn.Conv2d = ScaledStdConv2d, **kwargs: Any) -> NFResNet:
...
def nf_wide_resnet101_2(alpha: float = 0.2, activation: str = 'relu',
                        base_conv: nn.Conv2d = ScaledStdConv2d, **kwargs: Any) -> NFResNet:
